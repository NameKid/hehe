...
[
  ...(window.dataFromSubdomain && window.dataFromSubdomain.data.pageInfos
    ...
    : [
      ...
      { text: "15/8/2026
        Chắc bà đang tạo điều kiện cho tui nè, mấy ngày ròi ko liên hệ gì:) Haizzz shao tui lại mến bà thế này tr😗 Hoy cám ơn bà thời gian qua nhé. Thương em tới đây và tui dần biến mất😶 Bye Baby", image: "photo/photo5.jpg" },
    ]),
];
